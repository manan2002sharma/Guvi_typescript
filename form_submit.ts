function validateInput(name: string, email: string, contact: string, subject: string, message: string): boolean {
...
async function sendData(data: object) {
  try {
      const response = await fetch('https://67137e986c5f5ced6626992d.mockapi.io/api', {
          method: 'POST',
          headers: {
